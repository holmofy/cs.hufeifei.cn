...
|        矩阵        | <pre class="language-latex"><code class="language-latex">\begin{matrix}<br />x & y \\\\ <br />z & v <br />\end{matrix}</code></pre> |     $ \begin{matrix} x & y \newline z & v \end{matrix} $     |
|                    | <pre class="language-latex"><code class="language-latex">\begin{vmatrix} <br />x & y \\\\ <br />z & v <br />\end{vmatrix}</code></pre> |    $ \begin{vmatrix} x & y \newline z & v \end{vmatrix} $    |
|                    | <pre class="language-latex"><code class="language-latex">\begin{Vmatrix} <br />x & y \\\\ <br />z & v <br />\end{Vmatrix}</code></pre> |    $ \begin{Vmatrix} x & y \newline z & v \end{Vmatrix} $    |
|                    | <pre class="language-latex"><code class="language-latex">\begin{bmatrix} <br />0      & \cdots & 0      \\\\ <br />\vdots & \ddots & \vdots \\\\ <br />0      & \cdots & 0 <br />\end{bmatrix}</code></pre> | $ \begin{bmatrix} 0      & \cdots & 0 \newline \vdots & \ddots & \vdots \newline 0      & \cdots & 0 \end{bmatrix} $ |
|                    | <pre class="language-latex"><code class="language-latex">\begin{Bmatrix}<br />x & y \\\\ <br />z & v <br />\end{Bmatrix}</code></pre> |    $ \begin{Bmatrix} x & y \newline z & v \end{Bmatrix} $    |
|                    | <pre class="language-latex"><code class="language-latex">\begin{pmatrix} <br />x & y \\\\ <br />z & v <br />\end{pmatrix}</code></pre> |    $ \begin{pmatrix} x & y \newline z & v \end{pmatrix} $    |
|                    | <pre class="language-latex"><code class="language-latex">\bigl( \begin{smallmatrix}<br /> a&b\\\\ c&d <br />\end{smallmatrix} \bigr) </code></pre> | $ \bigl( \begin{smallmatrix} a&b \newline c&d \end{smallmatrix} \bigr)  $ |
|      条件定义      | <pre class="language-latex"><code class="language-latex">f(n) = <br />\begin{cases} <br />n/2,  & \mbox{if }n\mbox{ is even} \\\\ <br />3n+1, & \mbox{if }n\mbox{ is odd} <br />\end{cases}</code></pre> | $ f(n) = \begin{cases}  n/2,  & \mbox{if }n\mbox{ is even} \newline 3n+1, & \mbox{if }n\mbox{ is odd} \end{cases} $ |
|  多行等式、同余式  | <pre class="language-latex"><code class="language-latex">\begin{align} <br />f(x) & = (m+n)^2 \\\\<br />& = m^2+2mn+n^2 \\\\ <br />\end{align} </code></pre> | $ \begin{align} f(x) & = (m+n)^2 \newline & = m^2+2mn+n^2 \newline \end{align}  $ |
|                    | <pre class="language-latex"><code class="language-latex">\begin{align} <br />3^{6n+3}+4^{6n+3} <br />& \equiv (3^3)^{2n+1}+(4^3)^{2n+1}\\\\   <br />& \equiv 27^{2n+1}+64^{2n+1}\\\\ <br />& \equiv 27^{2n+1}+(-27)^{2n+1}\\\\ <br />& \equiv 27^{2n+1}-27^{2n+1}\\\\ <br />& \equiv 0 \pmod{91}\\\\ <br />\end{align}</code></pre> | $ \begin{align} 3^{6n+3}+4^{6n+3}  & \equiv (3^3)^{2n+1}+(4^3)^{2n+1} \newline & \equiv 27^{2n+1}+64^{2n+1} \newline & \equiv 27^{2n+1}+(-27)^{2n+1} \newline & \equiv 27^{2n+1}-27^{2n+1} \newline & \equiv 0 \pmod{91} \newline \end{align} $ |
