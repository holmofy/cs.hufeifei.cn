...
| Parallel <br/>scavenge(PSYoungGen)) | Parallel Mark Sweep <br/>Compact(ParOldGen) | -XX:+UseParallelOldGC<br/>(随-XX:+UseParallelGC开启) |
| Parallel(ParNew))                   | Serial Mark Sweep <br/>Compact(PSOldGen)    | -XX:+UseParNewGC<br/>(随-XX:+UseConcMarkSweepGC开启) |
